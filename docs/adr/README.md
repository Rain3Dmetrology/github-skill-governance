...
| [0009](./0009-github-native-single-use-c-authorization.md) | Protected GitHub Environment plus exact-digest, single-route C authorization | Environment active; PR-B1 workflow candidate |
